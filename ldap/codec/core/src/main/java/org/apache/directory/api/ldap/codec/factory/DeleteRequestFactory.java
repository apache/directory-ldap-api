...
public final class DeleteRequestFactory implements Messagefactory
{
    ...
    public void encodeReverse( Asn1Buffer buffer, Message message )
    {
        ...
        // The entry
        BerValue.encodeOctetString( buffer, Strings.getBytesUtf8(
            ( ( DeleteRequest ) message ).getName().getName() ) );

        // The DelRequest Tag
        BerValue.encodeSequence( buffer, LdapCodecConstants.DEL_REQUEST_TAG, pos );
    }
}
