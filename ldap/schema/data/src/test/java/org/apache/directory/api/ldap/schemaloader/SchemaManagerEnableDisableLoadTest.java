...
public class SchemaManagerEnableDisableLoadTest
{
    ...
    public void testLoadAllEnabled() throws Exception
    {
        ...
        assertEquals( 417, schemaManager.getAttributeTypeRegistry().size() );
        ...
        assertEquals( 658, schemaManager.getGlobalOidRegistry().size() );
    ...
    public void testEnableDisabled() throws Exception
    {
        ...
        assertTrue( schemaManager.getErrors().isEmpty() );
        assertEquals( 444, schemaManager.getAttributeTypeRegistry().size() );
        ...
        assertEquals( 701, schemaManager.getGlobalOidRegistry().size() );
