...
public class SchemaManagerEnableDisableLoadTest
{
    ...
    public void testLoadAllEnabled() throws Exception
    {
        ...
        assertEquals( 660, schemaManager.getGlobalOidRegistry().size() );
    ...
    public void testEnableDisabled() throws Exception
    {
        ...
        assertTrue( schemaManager.getErrors().isEmpty() );
        assertEquals( 446, schemaManager.getAttributeTypeRegistry().size() );
        ...
        assertEquals( 703, schemaManager.getGlobalOidRegistry().size() );
    ...
    public void testEnableDisabledDependingOnDisabled() throws Exception
    {
        ...
        assertEquals( 70, schemaManager.getSyntaxCheckerRegistry().size() );
        assertEquals( 75, schemaManager.getLdapSyntaxRegistry().size() );
        assertEquals( 761, schemaManager.getGlobalOidRegistry().size() );
